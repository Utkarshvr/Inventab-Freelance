...
export default function AddInvoice() {
    ...
    useEffect(() => {
        ...
        (async function () {
            try {
                setLoading(true);
                const { data } = await axios.get(`pipo/purchase-order/list/?org=${orgId}`,
                    {
                        signal: controller.signal,
                    });
                setLoading(false);
                ...
                const vendorArr = data.results
                    ...
                    .filter((vendor, index, self) => {
                        ...
                        return vendor.label !== null && self.findIndex((u) => u.label === vendor.label) === index;
                    });
            ...
            try {
                ...
                const typeArr = data.results
                    ...
                    .filter((type, index, self) => {
                        // Filter out null labels and duplicates
                        return type.label !== null && self.findIndex((u) => u.label === type.label) === index;
                    });
            ...
            try {
                ...
                const addressArr = data.results
                    ...
                    .filter((address, index, self) => {
                        // Filter out null labels and duplicates
                        return address.label !== null && self.findIndex((u) => u.label === address.label) === index;
                    });
            ...
            try {
                ...
                const deliveryArr = data.results
                    ...
                    .filter((delivery, index, self) => {
                        // Filter out null labels and duplicates
                        return delivery.label !== null && self.findIndex((u) => u.label === delivery.label) === index;
                    });
            ...
            try {
                ...
                const paymentArr = data.results
                    ...
                    .filter((payment, index, self) => {
                        // Filter out null labels and duplicates
                        return payment.label !== null && self.findIndex((u) => u.label === payment.label) === index;
                    });
                ...
                <div className="card-body">
                    <form onSubmit={handleSubmit}>
                        <div className="row">
                            ...
                            <div className="mb-3 col-md-6">
                                <label className="mb-2 text-dark text-capitalize">Po Type</label>
                                <Select
                                    placeholder="po type"
                                    isLoading={loading}
                                    isSearchable
