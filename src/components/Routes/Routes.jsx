...
import Mrp from "../purchase/Mrp";
import Pi from "../purchase/Pi";
import Po from "../purchase/Po";
import AddPi from "../purchase/AddPi";
import PurchaseDashboard from "../../pages/Dashboard/PurchaseDashboard/PurchaseDashboard";
import UpdatePi from "../purchase/UpdatePi";
import AddPo from "../purchase/AddPo";
import UpdatePo from "../purchase/UpdatePo";
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: "purchase/add-pi",
            element: <AddPi />,
          },
          {
            path: "purchase/update-pi/:id",
            element: <UpdatePi/>,
          },
          ...
          {
            path: "purchase/add-po",
            element: <AddPo/>,
          },
          {
            path: "purchase/update-po/:id",
            element: <UpdatePo />,
          },
