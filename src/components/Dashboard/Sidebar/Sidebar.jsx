          ...
          <ul className="metismenu" id="menu">
            ...
            <li>
              ...
              <ul aria-expanded="false">
                <li>
                  ...
                  {auth?.dept?.some((r) => r.role.name === "ENGINEERING") && (
                    <NavLink to="/dashboard/purchase" className="fs-4">
                      Purchase
                    </NavLink>
                  )}
                </li>
            ...
            {auth?.dept?.some((r) => r.role.name === "PURCHASE") && (
              <li>
                ...
                >
                  <LiaChartBarSolid className="fs-2" />
                  <span className="nav-text fs-4">Purchase</span>
                </a>
                <ul aria-expanded="false">
                  <li>
                    <NavLink to="purchase-mrp" className="fs-4">
                      MRP
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="purchase-pi" className="fs-4">
                      PI
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="purchase-po" className="fs-4">
                      po
                    </NavLink>
                  </li>
                </ul>
