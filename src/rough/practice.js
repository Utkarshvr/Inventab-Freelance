...
const s = {
  ...
  manufacturer: "CYUE INDUSTRIAL (HK) CO. LIMITED",
  gst_itm: "90318000",
  part_type: "Product",
  part_category: "Tools & Equipment",
  sub_category: "Hardware",
  uom: null,
  created: "2022-04-16T14:48:32.582271+05:30",
  modified: "2022-04-16T15:42:18.755741+05:30",
  internal_part_no: "1000000000",
  part_number: "wkvci12v001",
  customer_part_number: null,
  bom: false,
  short_description: "12v vehicle communication interface",
  long_description: "12v vehicle communication interface",
  mrp: 450,
  weight: "0.00",
  length: "0.00",
  breadth: "0.00",
...
const formatChartData = (kipPo) => {
  ...
  const formattedDataWithTotal = months.map((month) => {
    ...
    entry.cumulativeTotal = calculateCumulativeData(data, month); // Add the cumulative figures for the month
    return entry;
  });
