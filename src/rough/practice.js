...
const reports = [
  ...
  },
  {
    ...
    billing_address: {
      ...
      address:
        "KIRLOSKAR OIL ENGINES LTD. 13 L. K. ROAD, KHADKI, PUNE,Maharashtra INDIA",
    ...
    parts_invoice: [
      {
        ...
        parts_no: {
          ...
          gst_itm: {
            ...
            hsn_or_sac: "84621011",
            description:
              "MACHINE-TOOLS (INCLUDING PRESSES) FOR WORKING METAL BY FORGING, HAMMERING OR DIE-STAMPING; MACHINE-TOOLS (INCLUDING PRESSES) FOR WORKING METAL BY BENDING, FOLDING, STRAIGHTENING, FLATTENING, SHEARING, PUNCHING OR NOTCHING; PRESSES FOR WORKING METAL OR METAL CARBIDES, NOT SPECIFIED ABOVE - FORGING OR DIE-STAMPING MACHINES (INCLUDING PRESSES) AND HAMMERS: HAMMERS: STEAM OR AIR, SINGLE FRAME",
          },
          created: "2023-06-26T14:25:29.243496+05:30",
          modified: "2023-07-07T19:44:17.973355+05:30",
          internal_part_no: "1000000406",
          part_number:
            "9900050000 Parallel Flashing  Solution - for R550 & R1190 Lines",
          ...
          short_description:
            "9900050000 Parallel Flashing  Solution - for R550 & R1190 Lines",
          long_description:
            "( software license ,  VCI - ETHERNET , PC  Scanner etc.)",
          mrp: 972000,
          weight: "0.00",
          length: "0.00",
          breadth: "0.00",
          ...
          default: null,
          meta_tags: [],
          market_place: ["ee50ee2b-10e5-40e5-ad63-7bfa4ac39565"],
        },
      ...
      },
      {
        ...
        parts_no: {
          ...
          part_number:
            "9900050000 Parallel Flashing  Solution - for R810 Lines",
          customer_part_number:
            "9900050000 Parallel Flashing  Solution - for R810 Lines",
          bom: false,
          short_description:
            "9900050000 Parallel Flashing  Solution - for R810 Lineso",
          long_description:
            "( Software Licenses , VCL - Ethernet , PC , Scanner, etc.)",
          mrp: 921000,
          weight: "0.00",
          length: "0.00",
          breadth: "0.00",
      ...
      },
      {
        ...
        parts_no: {
          ...
          customer_part_number:
            "9900050000 Parallel Flashing  Solution - for DV Lines",
          bom: false,
          short_description:
            "9900050000 Parallel Flashing  Solution - for DV Lines",
          long_description:
            "( Software licences , VCI - Ethernet ,PC, Scanner , etc.)",
          mrp: 932000,
          weight: "0.00",
          length: "0.00",
          breadth: "0.00",
  ...
  },
  {
    ...
    org: {
      ...
      logo: null,
      address:
        "The Room, Central Park II, Sohna Road, Sector – 48 Gurugram, Haryana",
      pan_no: "",
      pan_cert: null,
    ...
    billing_address: {
      ...
      address:
        "Khasara No. 195, Industrial Area Raipur, Bhagwanpur, Tehsil Roorkee, Dist. Haridwar - 247661.",
    ...
    parts_invoice: [
      {
        ...
        warranty: 12,
        short_description:
          "GECAPEX000004242 -NEW PID UPDATION FOR OBDII A CNG ENGINE",
  ...
  },
  {
    ...
    billing_address: {
      ...
      address:
        "Plot No A/1, Nagar Road, Waluj Road, Waluj Aurangabad, Aurangabad-Maharashtra - 431133 (Bajaj Nagar)",
    ...
    parts_invoice: [
      {
        ...
        parts_no: {
          ...
          gst_itm: {
            ...
            hsn_or_sac: "85044090",
            description:
              "ELECTRICAL TRANSFORMERS, STATIC CONVERTERS (FOR EXAMPLE, RECTIFIERS) AND INDUCTORS -STATIC CONVERTERS: OTHER",
          },
    ...
    parts_invoice: [
      {
        ...
        parts_no: {
          ...
          customer_part_number:
            "9900050600 Diagnostics Runtime Android Application",
          bom: false,
          short_description:
            "9900050600 Diagnostics Runtime Android Application",
          long_description:
            "( Server Deployment, writing base parameters, routing tests ( except DV) EOL Application update)",
          mrp: 3750000,
          weight: "0.00",
          length: "0.00",
          breadth: "0.00",
    ...
    parts_invoice: [
      {
        ...
        parts_no: {
          ...
          gst_itm: {
            ...
            hsn_or_sac: "39232100",
            description:
              "ARTICLES FOR THE CONVEYANCE OR PACKING OF GOODS, OF PLASTICS; STOPPERS, LIDS, CAPS AND OTHER CLOSURES, OF PLASTICS - SACKS AND BAGS (INCLUDING CONES)OF POLYMERS OF ETHYLENE",
          },
          ...
          long_description:
            "(VCI Dongle with 9pin connector harness with OTG cable Set), Tester tool UDS Protocol,Autopeepal",
          mrp: 11000,
          weight: "0.00",
          length: "0.00",
          breadth: "0.00",
  ...
  },
  {
    ...
    billing_address: {
      ...
      address:
        "Sy.No.354, Automotive Park, Muppireddy Pally, Toopran (M), Medak (D.t) HYDERABAD 502336 TELANGA",
  ...
  },
  {
    ...
    billing_address: {
      ...
      address:
        "No 11 & 12, 4th Floor, Shri Samarth Complex, Kesnand Road, Wagholi, Pune - 412207",
      gst_no: "27AATCA4258N1ZW",
      gst_cert:
        "http://143.244.142.0/media/organization/gst/AA270522043653C_RC_24052022_GST.pdf",
      address_type: 2,
    },
    shipping_address: {
      id: "f71a8877-8438-4a1d-b978-7e03de52bc76",
    ...
    parts_invoice: [
      ...
      },
      {
        ...
        parts_no: {
          ...
          customer_part_number:
            "Diagnostic Tool Upgradation - CNG OBD II A for GCL",
          bom: false,
          short_description:
            "Diagnostic Tool Upgradation - CNG OBD II A for GCL",
          long_description:
      ...
      },
      {
        ...
        parts_no: {
          ...
          customer_part_number:
            "MSCO6561 - LIGIER ENGINE FLASHING SYSTEM for GCL",
          bom: false,
      ...
      },
      {
        ...
        parts_no: {
          ...
          customer_part_number:
            "Diagnostic Tool Upgradation - HD501 OBDIIA for GCL",
          bom: false,
          short_description:
            "Diagnostic Tool Upgradation - HD501 OBDIIA for GCL",
          long_description:
  ...
  },
  {
    ...
    org: {
      ...
      logo: null,
      address:
        '"C-7,Panki Site No.III, UPSIDC, Industrial Area, Kanpur-208022-(INDIA)"',
      pan_no: "",
      pan_cert: null,
      ...
      marketplace: null,
      meta_tags: [5],
      role: ["8a75ff00-e101-48bc-9a0c-494732bd3fd5"],
    },
    invoice_type: {
      id: "138fef7c-8785-4b16-9deb-0fd49902f5fa",
      created: "2021-08-10T07:30:43.125089+05:30",
  ...
  },
  {
    ...
    org: {
      ...
      logo: null,
      address:
        "Plot no.385, Khata No.76, Shail Enterprises, Bharat Mata Chowk, Ranchi, Ranchi, Jharkhand, 834001.",
      pan_no: "",
      pan_cert: null,
  ...
  },
  {
    ...
    billing_address: {
      ...
      address:
        "8B, National Highway, Near Microwave Tower, Shapal (Veraval), District Rajkot",
  ...
  },
  {
    ...
    org: {
      ...
      marketplace: "ee50ee2b-10e5-40e5-ad63-7bfa4ac39565",
      meta_tags: [],
      role: ["fb457513-7de8-469a-b1e6-5c5666f6f6b8"],
    },
    invoice_type: {
      id: "138fef7c-8785-4b16-9deb-0fd49902f5fa",
      created: "2021-08-10T07:30:43.125089+05:30",
    ...
    billing_address: {
      ...
      address:
        "FIVE STAR INDUSTRIAL AREA AUTOMOTIVE DIVISION - SPARES A-1/3, M.I.D.C SHENDRA, AURANGABAD",
    ...
    parts_invoice: [
      {
        ...
        parts_no: {
          ...
          gst_itm: {
            ...
            hsn_or_sac: "84781020",
            description:
              "MACHINERY FOR PREPARING OR MAKING UP TOBACCO, NOT SPECIFIED OR INCLUDED ELSEWHERE IN THIS CHAPTER - MACHINERY: CIGARETTE MAKING MACHINERY",
          },
          ...
          bom: true,
          short_description:
            "Vehicle Communication VCI(12V) wikitek1 Android Application",
          long_description:
            "Vehicle Communication VCI(12V) wikitek1 Android Application",
          mrp: 2,
          weight: "0.00",
  ...
  },
  {
    ...
    org: {
      ...
      logo: null,
      address:
        "akole dist-ahmednagar maharastra, Ahmed Nagar, Maharashtra, India, 422601",
      pan_no: null,
      pan_cert: null,
  ...
  },
  {
    ...
    org: {
      ...
      logo: null,
      address:
        "#CTS NO 3293, BASWANT COMPLEX, NEAR SAI BHAVAN MANGAL KARYALAYA, KHASBAG, BELGAVI-590003.",
      pan_no: "",
      pan_cert: null,
  ...
  },
  {
    ...
    org: {
      ...
      logo: null,
      address:
        "Kollanpady, Irumpanam, P. O. Thripunithura, Ernakulam - 682301.",
      pan_no: "",
      pan_cert: null,
  ...
  },
  {
    ...
    billing_address: {
      ...
      address:
        "J 2 MIDC INDUSTRIAL AREA,CHIKALTHANA LIGHT ENGINES UNIT I ,AURANGABAD",
      gst_no: "27AAACG2062M1ZL",
      gst_cert: null,
      address_type: 3,
    },
  ...
  },
  {
    ...
    billing_address: {
      ...
      address:
        "Survey No. 521, 525, 530, 541-542, Near Moghal Mataji Mandir, Ahmedabad-Rajkot Highway, Bhayla, Dist. Ahmedabad - 382220, Gujrat, India.",
    ...
    parts_invoice: [
      {
        ...
        parts_no: {
          ...
          bom: false,
          short_description:
            "Lenovo  10.6 Tab M10 3rd  Generation wifi 6+1 128",
  ...
  },
  {
    ...
    billing_address: {
      ...
      address:
        "Plot No. 52/1, 52/2, Indore Ratlam Highway, Village Baggad, Dist. Dhar, M. P. - 454666.",
    ...
    parts_invoice: [
      {
        ...
        warranty: 12,
        short_description:
          "9900050000 Parallel Flashing  Solution - for 4K/6K & SL90 Lines",
  ...
  },
  {
    ...
    org: {
      ...
      address:
        "SKY ONE’ 8th Floor, S.No.210, Final Plot No. 72, Town Planning Scheme, Yerwada No 1, Kalyani Nagar",
      pan_no: "pan",
      pan_cert: null,
    ...
    parts_invoice: [
      {
        ...
        parts_no: {
          ...
          bom: false,
          short_description:
            "G435 Addition in PATT tool & Diagnostics adviser tool",
          long_description:
            "G435 Addition in PATT tool & Diagnostics adviser tool",
          mrp: 300000,
          weight: "0.00",
    ...
    parts_invoice: [
      {
        ...
        parts_no: {
          ...
          customer_part_number:
            "MSC090002 EOL ECU FLASHING -Application for GCL",
          bom: false,
  ...
  },
  {
    ...
    org: {
      ...
      logo: null,
      address:
        "D. No. 26/335-13, Opp - Central Warehouse Godown, Railway Station Road, Nandyal, A. P., India.",
      pan_no: "",
      pan_cert: null,
    ...
    parts_invoice: [
      {
        ...
        parts_no: {
          ...
          gst_itm: {
            ...
            hsn_or_sac: "84621019",
            description:
              "MACHINE-TOOLS (INCLUDING PRESSES) FOR WORKING METAL BY FORGING, HAMMERING OR DIE-STAMPING; MACHINE-TOOLS (INCLUDING PRESSES) FOR WORKING METAL BY BENDING, FOLDING, STRAIGHTENING, FLATTENING, SHEARING, PUNCHING OR NOTCHING; PRESSES FOR WORKING METAL OR METAL CARBIDES, NOT SPECIFIED ABOVE - FORGING OR DIE-STAMPING MACHINES (INCLUDING PRESSES) AND HAMMERS: HAMMERS: OTHER",
          },
  ...
  },
  {
    ...
    billing_address: {
      ...
      address:
        "Royal Enfield, ORG (A unit of Eicher Motors Ltd.) PLOT NO.A-19/1, SIPCOT INDUSTRIAL GROWTH CENTRE, 602105 ORAGADAM-KANCHEEPURAM INDIA",
  ...
  },
  {
    ...
    org: {
      ...
      logo: null,
      address:
        "D.No.-217, Near Sree Sree Statue, ape circle,Bypass Road,Khammam-507002",
      pan_no: "",
      pan_cert: null,
...
const dueIn15Days = results.filter(
  (result) =>
    result.age < 0 && result.age >= -15 && result.dept.name === "SLS-KAM-WEST"
);

console.log({
  dueIn15Days: dueIn15Days.forEach((part) => parts_invoice.length),
});
